...
System::Void MyProject::PracticeForm::PracticeForm_Load(System::Object^ sender, System::EventArgs^ e)
{
	...
	if (readFromFile(questsPractice) == false) {
		MessageBox::Show("Íå óäàåòñÿ íàéòè ôàéë", "Îøèáêà!");
...
System::Void MyProject::PracticeForm::âÃëàâíîåÌåíþToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	MyForm^ form = gcnew MyForm();
	this->Close();
	form->Show();
...
System::Void MyProject::PracticeForm::èçÏðîãðàììûToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	Application::Exit();
	return System::Void();
}
